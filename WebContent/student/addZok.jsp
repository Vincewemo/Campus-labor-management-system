	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			<div class="jumbotron" style="background:#ADD8E6">
				<h1>
					成功选择志愿劳动信息!请等待管理员核实信息
				</h1>
				<p>
					 <a class="btn btn-primary btn-large" href="/jiemian/student/xueshengshouye.jsp">返回学生页面</a>
					 <a class="btn btn-primary btn-large" href="/jiemian/student/allzhiyuan.jsp">返回志愿页面</a>
