	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			<div class="jumbotron" style="background:#ADD8E6">
				...
				<p>
					 <a class="btn btn-primary btn-large" href="/jiemian/student/xueshengshouye.jsp">返回学生首页</a>
					 <a class="btn btn-primary btn-large" href="/jiemian/student/allzhiyuan.jsp">选择志愿</a>
