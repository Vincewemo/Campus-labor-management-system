...
<form action="mark1" method = "post">
<div style="margin-left: 40%">

 <div class="layui-form-item" >
    <label class="layui-form-label">签到框</label>
    <div class="layui-input-inline">
      <input name="qd2"  placeholder="请输入'签到'" autocomplete="off" class="layui-input">
    </div>
...
<div align="center">
<!-- <a href="/jiemian/student/Wednesday.jsp">下一天</a> -->
