...
<form  class="layui-form" action="AT" method="post">
   <div class="layui-form-item"  style="margin-left: 150px">
    ...
    <div class="layui-input-inline" style="margin-left: 1%">
      <input type="text" name="An" required  lay-verify="required" placeholder="输入账号名" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item" style="margin-left: 150px">
    ...
    <div class="layui-input-inline" style="margin-left: 1%">
      <input type="password" name="Ap" required lay-verify="required" placeholder="输入账号密码" autocomplete="off" class="layui-input">
    </div>
   ...
   <div class="layui-form-item" style="margin-left: 150px">
    ...
    <div class="layui-input-inline" style="margin-left: 1%">
      <input type="password" name="Am" required lay-verify="required" placeholder="输入管理员秘钥" autocomplete="off" class="layui-input">
    </div>
