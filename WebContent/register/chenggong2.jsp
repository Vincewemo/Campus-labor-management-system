...
<body background="/jiemian/images/chenggong.jpg">
...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<a class="btn btn-danger" href="/jiemian/Login.jsp"  >点击登录</a> 
			
			
			<a class="btn btn-danger" href="/jiemian/register/Azhuce.jsp" >返回注册</a> 
		</div>
	</div>
</div>
